...
public class GoogleProductSearchApiTest extends EasyMockSupport {
	...
	public void setUp() throws Exception {
		httpClient = createMock(IHttpClient.class);
		manager = new ProductIdentificationPluginManager("plugin.GoogleProductSearchApi",
				httpClient);
	}
	...
	public void testGetDescriptionForProduct() {
		...
		String desc = manager.getDescriptionForProduct("0885911003940");
	...
	public void testGetNullDescriptionForProduct() {
		...
		String desc = manager.getDescriptionForProduct("088591100394a");
		assertTrue(desc == null);
